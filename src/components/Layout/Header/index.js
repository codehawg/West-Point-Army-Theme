      ...
      <div className='header' >
        <div className='header-stripe' ref={(ref) => this.header = ref} draweropen={`${this.state.drawerOpen}`}>
          ...
          <div className="social">
            ...
            <a href="https://www.westpoint.edu/" class="homepage" alt="USMA West Point Homepage">USMA West Point</a>
            <a href="https://www.facebook.com/WestPointUSMA/" class="fa fa-facebook"></a>
            <a href="https://twitter.com/WestPoint_USMA" class="fa fa-twitter"></a>      
            <a href="https://www.instagram.com/westpoint_usma" class="fa fa-instagram"></a>            
            <a href="https://www.youtube.com/user/TheWestPointChannel" class="fa fa-youtube"></a>      
            <a href="https://www.flickr.com/photos/west_point/" class="fa fa-flickr"></a>                                                                      
          </div>             
